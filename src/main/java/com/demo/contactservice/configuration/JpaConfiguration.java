package com.demo.contactservice.configuration;
...
@Configuration
@EnableJpaRepositories(basePackages = "com.demo.contactservice.repository",
...
public class JpaConfiguration {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException {
		...
		factoryBean.setPackagesToScan(new String[] { "com.demo.contactservice.entity" });
	...
	private Properties jpaProperties() {
		...
		if(environment.getRequiredProperty("datasource.sampleapp.defaultSchema") != null && environment.getRequiredProperty("datasource.sampleapp.defaultSchema").trim().length() > 0){
